...
class CapennaStory5 extends StatelessWidget {
  const CapennaStory5({Key? key}) : super(key: key);
...
"It's the quietest section of the city we've seen so far," Vivien admitted.''',
                  ...
                  Padding(
                    ...
                    child: Image.asset(
                      'assets/images/streets_of_new_capenna/story/content/epi5-1.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
"Kamiz," Jinnie said with relief. "How is Jetmir?"''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/streets_of_new_capenna/story/content/epi5-2.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
"Park Heights. The main Obscura stronghold, the Cloud Spire. If it's not safe there, we won't be safe anywhere."''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/streets_of_new_capenna/story/content/epi5-3.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/streets_of_new_capenna/story/content/epi5-4.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
"My family. I'm home," Giada said reverently, as if struck with unexpected clarity.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/streets_of_new_capenna/story/content/epi5-5.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
"Run," Ob Nixilis growled as Vivien passed. His voice was sandpaper and fire. "Play with my agents until I'm ready to torment you." He kept his focus solely on Elspeth and Giada, wearing a cruel smile. Self-satisfied. As though everything was kindling for him to burn. "You thought you could best me? I'll show you what happens to people who dare contradict me—who even think of getting in the way of my power. Once the Font is in my possession, I'll end you both, one at a time, slowly."''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/streets_of_new_capenna/story/content/epi5-6.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
Light filled the room. It shot out in every direction from Giada's body, the force of the blast strong enough to throw Ob Nixilis away. Elspeth, however, was unaffected. She looked on in awe as Giada was transformed into the radiant magic of Halo.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/streets_of_new_capenna/story/content/epi5-7.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
Elspeth would defend New Capenna.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/streets_of_new_capenna/story/content/epi5-8.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
"Dominaria." Elspeth turned away from the city skyline of New Capenna. "Time to meet some old friends."''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/streets_of_new_capenna/story/content/epi5-9.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/streets_of_new_capenna/story/content/epi5-10.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                ],
