...
class CapennaSideStory2 extends StatelessWidget {
  const CapennaSideStory2({Key? key}) : super(key: key);
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Image.asset(
                      'assets/images/streets_of_new_capenna/side_story/content/epi2-1.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
"I see glowering and silent disapproval in your future, Queza," Tivit called. "I see. . .no, I see. . ."''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/streets_of_new_capenna/side_story/content/epi2-2.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
"We'll know soon enough." Kamiz straightened her cuffs and walked to the back tapestries. Raffine was calling her to the Cloud Spire.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/streets_of_new_capenna/side_story/content/epi2-3.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
Kamiz swallowed the lump in her throat. "Understood."''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/streets_of_new_capenna/side_story/content/epi2-4.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
"Good. Let's go find a reporter."''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/streets_of_new_capenna/side_story/content/epi2-5.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
"These are connected to Lacey." Oskar handed Kamiz a notepad, a business card, and a tight scroll. All three were blank.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/streets_of_new_capenna/side_story/content/epi2-6.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
"Understood," the aven surveillance chief responded. She closed the link and took a cleansing breath. The doors opened. Raffine paced as before. For a moment she looked. . .smaller. Diminished. As she knelt, Kamiz inspected the sanctum's magnificent architecture. The walls, the carvings. The stained glass.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/streets_of_new_capenna/side_story/content/epi2-7.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
Lagrella pulled a scroll and fountain pen from her coat. "The Prophecy is locked in a vault below Nido Sanctuary. A demon foretold New Capenna's destruction. When the city's Halo supply is gone, we die. I don't mind telling you, soon you won't remember."''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/streets_of_new_capenna/side_story/content/epi2-8.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
