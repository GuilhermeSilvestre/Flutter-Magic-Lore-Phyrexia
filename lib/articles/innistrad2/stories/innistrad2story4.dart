...
class Innistrad2Story4 extends StatelessWidget {
  const Innistrad2Story4({Key? key}) : super(key: key);
...
Tonight, they break down the doors of this awful castle. Tonight, they fight tooth, nail, claw, and sword to take back the day.''',
                  ...
                  Padding(
                    ...
                    child: Image.asset(
                      'assets/images/innistrad2/story/content/epi4-1.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
The light up ahead is proof of that.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/innistrad2/story/content/epi4-2.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
"Leave the fight to us," Kaya says. "Go."''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/innistrad2/story/content/epi4-3.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/innistrad2/story/content/epi4-4.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
