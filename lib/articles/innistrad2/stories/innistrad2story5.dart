...
class Innistrad2Story5 extends StatelessWidget {
  const Innistrad2Story5({Key? key}) : super(key: key);
...
Chandra's right at home in the chaos. As a vampire's claw rakes across Adeline's shield, Chandra is there, bounding up onto a table to get a better angle. Their eyes link over the vampire's shoulder. Somehow—despite the screams, despite the obscenities, despite the death grunts around them—Chandra's smirking.''',
                  ...
                  Padding(
                    ...
                    child: Image.asset(
                      'assets/images/innistrad2/story/content/epi5-1.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
It's Tovolar.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/innistrad2/story/content/epi5-2.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/innistrad2/story/content/epi5-3.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
"I know," she says. "I know."''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/innistrad2/story/content/epi5-4.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
Even though her friends will soon be gone, Arlinn Kord has her pack.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/innistrad2/story/content/epi5-5.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                ],
