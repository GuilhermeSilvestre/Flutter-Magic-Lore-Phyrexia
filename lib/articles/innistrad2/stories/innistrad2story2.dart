...
class Innistrad2Story2 extends StatelessWidget {
  const Innistrad2Story2({Key? key}) : super(key: key);
...
"But she's far from it! I won't believe it until I see it myself."''',
                  ...
                  Padding(
                    ...
                    child: Image.asset(
                      'assets/images/innistrad2/story/content/epi2-1.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
Olivia Voldaren has finally arrived.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/innistrad2/story/content/epi2-2.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/innistrad2/story/content/epi2-3.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/innistrad2/story/content/epi2-4.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
He takes her hand. For long, horrible moments, he drinks the blood from her wrist. Only after this does he rise from the coffin.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/innistrad2/story/content/epi2-5.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
