...
class Innistrad2SideStory1 extends StatelessWidget {
  const Innistrad2SideStory1({Key? key}) : super(key: key);
...
"No need to thank me," he says. "I was in the neighborhood."''',
                  ...
                  Padding(
                    ...
                    child: Image.asset(
                      'assets/images/innistrad2/side_story/content/epi1-1.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
                    padding: EdgeInsets.symmetric(vertical: 12),
                    child: Text(
                      '''A lie, but he will add the stagecoach to the bill. He had to offer the driver a hefty bribe to even consider the trip. The villages along the Alrun River were inhospitable even before The Travails, but now. . .well, Jacob just wishes that when the Plane decided to plunge itself into permanent night, he could have been caught somewhere that didn't reek of fish and rotting infrastructure.
...
Nellick laughs, although it wasn't a joke. His smile doesn't show his teeth. "Surely I can convince the two of you to stay the night. Well—so to speak, at least." He lets out a polite little chuckle, as if the end of Innistrad is just drawing-room banter.
...
"Oh, it's vacant. A necro-alchemist lived there, but not anymore. There was an incident a few months ago. A geistbomb misfired. Killed a bunch of people."''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/innistrad2/side_story/content/epi1-2.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
Jacob remembers Selhoff in the height of summer—the colors and smells and drifting music. He's no tavern-crawler, but he likes to watch the crowd. Anything to remind him that Innistrad isn't dead.
...
The screaming woman turns on him, finally solid enough for him to make out details. Wild hair, round eyes, strong shoulders, and a furious mouth.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/innistrad2/side_story/content/epi1-3.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
Jacob puts his teacup down. "The end of Innistrad?"
...
He hadn't noticed, and he should have. Just, he'd been so shaken by Millicent's attacks, and, the truth is, no one in Innistrad has been at the peak of their powers in the last few years since The Travails. The changed magic unbalances the weather, which unbalances the Plane, which unbalances people. Still, he should have noticed that he's only truly spoken to one person since arriving in Selhoff.
...
"Anywhere. I can set up a laboratory anywhere on Innistrad. You can solve your geist crimes, whatever you want." He looks up, thoughtful. "Or we can find the people who killed your friend, and we can make them pay. Together."
...
''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/innistrad2/side_story/content/epi1-4.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
