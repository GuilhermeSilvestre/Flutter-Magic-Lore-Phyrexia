...
class Innistrad2SideStory2 extends StatelessWidget {
  const Innistrad2SideStory2({Key? key}) : super(key: key);
...
The vampires fought side by side with us. They wanted to save this Plane like we did. But I couldn't help thinking, "To what end?" To make slaves of us all? Food? But there was no time to think of the future, only the present. Only the present enemy that must be destroyed. We'll have to deal with them when this is all over.
...
Thalia''',
                  ...
                  Padding(
                    ...
                    child: Image.asset(
                      'assets/images/innistrad2/side_story/content/epi2-1.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
"The tears of Avacyn rest above the altar where they can drink the light of the moon, Madam Henrika."''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/innistrad2/side_story/content/epi2-2.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
Henrika smiled, rolling her eyes coyly, before she answered, "Perhaps."''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/innistrad2/side_story/content/epi2-3.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
"Olivia Voldaren!" shouted Thalia. "Lady of Lurenbraum, progenitor of the Voldaren line, made a pact on behalf of all vampires on Innistrad. She agreed—she promised—no vampire bite or blade would draw human blood until the war was over. She and the other vampires are still fighting out there. All other bloodlines are fighting so that this Plane can survive. You must honor that!"
...
In a final attempt to prolong what now seemed inevitable, Odric gave a scream and erupted from the fanged shackles of the vampire horde. He leaped in front of the sword moments before it was to take Thalia's hand and accepted the full force of the attack across his chest. Blood spurted and spilled out of him like a fountain.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/innistrad2/side_story/content/epi2-4.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
"Odric, no," Thalia cried, watching him quickly succumb to the blow. "Don't die! Don't you die on me! We have a Plane to save!"
...
Looking over her shoulder in horror, Henrika beheld Thalia, staring up at her, eyes fierce and determined. Her gaze was then torn away by a warrior's cry and met the eyes of the one who would end her. Odric was now charging through the air, eyes glowing the color of two crimson suns, fangs flashing, and the sword of Avacyn glowing brighter than ever before.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/innistrad2/side_story/content/epi2-5.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
