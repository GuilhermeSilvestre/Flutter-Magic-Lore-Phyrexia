...
class DominariaStory2 extends StatelessWidget {
  const DominariaStory2({Key? key}) : super(key: key);
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Image.asset(
                      'assets/images/dominaria_united/story/content/epi2-1.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
"Have I not been warning you of this?" The young nobleman from New Argive stood. Based on his gold-embroidered and fur-lined finery, he had to be an important official. "Phyrexian sleeper agents will permeate every layer of society if we do not act now. For all we know, they already have!"''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/dominaria_united/story/content/epi2-2.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
Karn stared at the varied thrush, so still, so attentive. "Perhaps."''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/dominaria_united/story/content/epi2-3.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/dominaria_united/story/content/epi2-4.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
Karn strode forward, Teferi and Ajani flanking him. Jaya held up her hands, summoning fire into her palms. Jodah gathered energy, distorting the air around him with ribbons of color, and then solidified it into a forcefield to protect the unchanged Benalish soldiers from the Phyrexians.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/dominaria_united/story/content/epi2-5.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
