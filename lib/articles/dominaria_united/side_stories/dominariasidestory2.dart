...
class DominariaSideStory2 extends StatelessWidget {
  const DominariaSideStory2({Key? key}) : super(key: key);
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Image.asset(
                      'assets/images/dominaria_united/side_story/content/epi2-1.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
But the viashino had turned away. Glaring at Brotten, he hissed and sprang forward. The student stepped between him and Brotten, and with a bellow, the viashino batted her away.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/dominaria_united/side_story/content/epi2-2.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
Jared cast Ulf a quick glance, and Ulf saw something different in it this time, a measure of curiosity. "You can't have the boy and you can't have me," Jared said. And he drew his sword.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/dominaria_united/side_story/content/epi2-3.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
"Yes," she said. "How lucky you found the book, Jared. Once you've played the hero here yet again, Corondor will be waiting for you."''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/dominaria_united/side_story/content/epi2-4.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                ],
