...
class InnistradStory5 extends StatelessWidget {
  const InnistradStory5({Key? key}) : super(key: key);
...
She blinks. Back to the present.''',
                  ...
                  Padding(
                    ...
                    child: Image.asset(
                      'assets/images/innistrad1/story/content/epi5-1.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
The Grand Cathedral in Thraben. Worrin behind a desk. Innistrad was born in darkness, and to the darkness it longs to return. It is for that reason we must each tend to our own light.
...
She stands, her hand still buried in him. "Call off the attack."''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/innistrad1/story/content/epi5-2.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
Chanting meets them first. Arlinn can't make out the words, but the sounds have the shape of towering oaks and old rivers. A glow runs up the arms of the Celestus, and she thinks to herself, slumped against Adeline, that they look like her father's tongs, fresh from the fire.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/innistrad1/story/content/epi5-3.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
"I will," she answers. Of that, she's sure.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/innistrad1/story/content/epi5-4.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/innistrad1/story/content/epi5-5.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
