...
class InnistradStory4 extends StatelessWidget {
  const InnistradStory4({Key? key}) : super(key: key);
...
"I think so," says the messenger. From the sound of his voice, it was probably Feuer. Didn't he have some bones he should be reassembling? Olivia never met a finer purveyor of ossuary furniture, but why was he here? "They're up to something. Trying to restore the balance of day and night, I believe."''',
                  ...
                  Padding(
                    ...
                    child: Image.asset(
                      'assets/images/innistrad1/story/content/epi4-1.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
Her chest goes tight.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/innistrad1/story/content/epi4-2.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
Teferi. She has to thank him after this.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/innistrad1/story/content/epi4-3.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
He smirks, shakes his head. "No."''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/innistrad1/story/content/epi4-4.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
And Arlinn Kord changes with it.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/innistrad1/story/content/epi4-5.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                ],
