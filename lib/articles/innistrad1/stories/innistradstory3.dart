...
class InnistradStory3 extends StatelessWidget {
  const InnistradStory3({Key? key}) : super(key: key);
...
She swallows. As ants around their hill, the zombies around the cathedral. Getting past them will be no easy feat.''',
                  ...
                  Padding(
                    ...
                    child: Image.asset(
                      'assets/images/innistrad1/story/content/epi3-1.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
"Don't bother," she says. "Just give me five minutes before you follow."''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/innistrad1/story/content/epi3-2.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
How strange to see a ghost's eyes go wide. "My father? Has he sent for me?"''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/innistrad1/story/content/epi3-3.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
Teferi holds up his hands, standing just in front of Chandra. "If you won't listen to her, listen to me. Innistrad is your family, Sorin, we all know that. You've done more than enough. We're asking for the key so we can do our part. Arlinn here doesn't want to see eternal night any more than you do."
...
But Sigarda does.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/innistrad1/story/content/epi3-4.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
It is Chandra who finds the room—festooned with bookshelves and antique weapons—and Teferi who finds the Moonsilver Key. It sits in the offering hands of a statue. Sorin must have lopped the head off of it, but the armor and wings leave little doubt who it used to be. The headless Avacyn sits beneath a portrait of a young Sorin and his grandfather dressed in their finest.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/innistrad1/story/content/epi3-5.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
