...
class PhyrexiaStory5 extends StatelessWidget {
  const PhyrexiaStory5({Key? key}) : super(key: key);
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  const Center(
                    child: Text(
                      'ASSAULT ON NEW PHYREXIA | EPISODE 5: INEVITABLE RESOLUTIONS',
                      style: TextStyle(
                        fontSize: 22,
                  ...
                  Padding(
                    ...
                    child: Image.asset(
                      'assets/images/phyrexia/story/content/epi5-1.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
He sighed heavily, looking suddenly exhausted. "And there is no other way. Better to fulfill the promise of the sylex and scorch the branches, sweep it all away, than to lose the entire Multiverse. Bring the ending. Topple the empires to bring a fresh start. Renew it all."''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/phyrexia/story/content/epi5-2.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
"I can handle this devil," he said. "He owes me a death for what he did to my plane. Go. Find the others. I'll be fine."''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/phyrexia/story/content/epi5-3.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
She didn't hesitate. In a single convulsive motion, she drove her blade through Jace and shoved him aside, letting his body take the sword with him as he fell and grabbing the sylex in her own hands.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/phyrexia/story/content/epi5-4.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
With that, Elesh Norn raised her hand, clicking her perfect claws together, and the invasion began.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/phyrexia/story/content/epi5-5.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                ],
