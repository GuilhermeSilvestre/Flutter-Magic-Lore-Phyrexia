...
class MarchPfTheMachineStory5 extends StatelessWidget {
  const MarchPfTheMachineStory5({Key? key}) : super(key: key);
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  const Center(
                    child: Text(
                      'MARCH OF THE MACHINE | EPISODE 5: CATHARTIC REUNION',
                      style: TextStyle(
                        fontSize: 22,
...
"Come now, we mustn't take root," is the only thing Wrenn says before she starts moving. The flames within her spit crackle against their containment. Fire is always eager to show how it feels.''',
                  ...
                  Padding(
                    ...
                    child: Image.asset(
                      'assets/images/march_of_the_machine/story/content/epi5-1.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
The runes beneath their feet flash to life. An instant later they're shot straight into the air with only the stone beneath them as an anchor. Air whips across their faces; Chandra shields her eyes to keep them from tearing up.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/march_of_the_machine/story/content/epi5-2.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
Nissa holds out her hand. "Please, come with us. I miss you."''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/march_of_the_machine/story/content/epi5-3.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
