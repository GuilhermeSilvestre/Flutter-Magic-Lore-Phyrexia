...
class MarchPfTheMachineStory4 extends StatelessWidget {
  const MarchPfTheMachineStory4({Key? key}) : super(key: key);
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  const Center(
                    child: Text(
                      'MARCH OF THE MACHINE | EPISODE 4: BENEATH EYES UNBLINKING',
                      style: TextStyle(
                        fontSize: 22,
...
The odds, he knows, are not good.''',
                  ...
                  Padding(
                    ...
                    child: Image.asset(
                      'assets/images/march_of_the_machine/story/content/epi4-1.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
"We think the Phyrexians might understand its importance, or else feel a pull toward the aether stored there," Saheeli answers. "If you'll notice, they're all heading straight for it."''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/march_of_the_machine/story/content/epi4-2.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
Beautiful.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/march_of_the_machine/story/content/epi4-3.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
