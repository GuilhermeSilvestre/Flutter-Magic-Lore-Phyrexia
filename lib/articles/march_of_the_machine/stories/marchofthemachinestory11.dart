...
class MarchPfTheMachineStory11 extends StatelessWidget {
  const MarchPfTheMachineStory11({Key? key}) : super(key: key);
...
Teferi digs. The earth is warm, the soil dark and rich. He lays the acorn in the little clearing he has made, then fills it in. Water from his own gourd he offers her. He sits next to the little mound and sighs.''',
                  ...
                  Padding(
                    ...
                    child: Image.asset(
                      'assets/images/march_of_the_machine/story/content/epi11-1.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/march_of_the_machine/story/content/epi11-2.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
His answer comes when Ajani's good eye flutters open, when breath returns to his scarred chest. Despite his injuries, he forces himself to sit up. "What . . . Where am I?"''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/march_of_the_machine/story/content/epi11-3.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
