...
class MarchPfTheMachineStory9 extends StatelessWidget {
  const MarchPfTheMachineStory9({Key? key}) : super(key: key);
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  const Center(
                    child: Text(
                      'MARCH OF THE MACHINE | ZENDIKAR: BATTLES IN THE FIELD AND IN THE MIND',
                      style: TextStyle(
                        fontSize: 22,
...
She looks down at her own arms, freshly covered by the glowing, shining symbols of Phyrexia and where her hands once were, there are now two burning stone blades.''',
                  ...
                  Padding(
                    ...
                    child: Image.asset(
                      'assets/images/march_of_the_machine/story/content/epi9-1.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
"No, but this is!" snaps Akiri and points at the Skyclave looming before them, it's thrumming hedrons and dripping oil. Then to the dead landscape below. "A few days ago, the land was green. It was full of life. The more hedrons connected, the quicker the enemy arrives. Nahiri is going to destroy our home if we do nothing."''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/march_of_the_machine/story/content/epi9-2.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/march_of_the_machine/story/content/epi9-3.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
