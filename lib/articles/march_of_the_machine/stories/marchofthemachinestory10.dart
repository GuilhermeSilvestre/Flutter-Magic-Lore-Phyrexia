...
class MarchPfTheMachineStory10 extends StatelessWidget {
  const MarchPfTheMachineStory10({Key? key}) : super(key: key);
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  const Center(
                    child: Text(
                      'MARCH OF THE MACHINE | EPISODE 9: THE OLD SINS OF NEW PHYREXIA',
                      style: TextStyle(
                        fontSize: 22,
...
Like motes of dust, they travel the winds toward their destination. Some wrap about the throat of a thrashing sea monster, holding it in place long enough for a crew of sailors to sever its heads. Others make their way to temples. The gods who call it home matter not; supplicants in need of protection soon find it. The black oil smeared across a fleeing woman's arm miraculously avoids her wounds; a javelin thrower turns the second before he would have found himself skewered.''',
                  ...
                  Padding(
                    ...
                    child: Image.asset(
                      'assets/images/march_of_the_machine/story/content/epi10-1.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
Very well. Let Zhalfir look after that.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/march_of_the_machine/story/content/epi10-2.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
"Look around," Teferi calls. "It seems to me New Phyrexia's the one getting left behind."''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/march_of_the_machine/story/content/epi10-3.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
Violence, even in the service of the greater good, should never be easily wrought.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/march_of_the_machine/story/content/epi10-4.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
