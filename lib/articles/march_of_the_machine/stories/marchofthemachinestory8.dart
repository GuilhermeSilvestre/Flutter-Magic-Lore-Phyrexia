...
class MarchPfTheMachineStory8 extends StatelessWidget {
  const MarchPfTheMachineStory8({Key? key}) : super(key: key);
...
From hand to hand she passes, tossed through the air to keep her out of Phyrexian clutches. The Phyrexians think humans know little of unity—but Wrenn knows otherwise.''',
                  ...
                  Padding(
                    ...
                    child: Image.asset(
                      'assets/images/march_of_the_machine/story/content/epi8-1.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/march_of_the_machine/story/content/epi8-2.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
How handsome he's become. Happiness wells up within her. She feels herself smile, although she isn't certain how; her body is distant and cold. Only the fires here give her any warmth. But what will they do once those fires have burned themselves out? Wrenn doesn't know. But she does know she's got a fine new partner.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/march_of_the_machine/story/content/epi8-3.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/march_of_the_machine/story/content/epi8-3-2.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
With a thought she calls to Eight, and Eight is quick to answer. A questing branch opens a tear into this tangled bramble. Quick as its creator the tear grows into something greater: a portal big enough for someone to walk through.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/march_of_the_machine/story/content/epi8-4.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
Wrenn closes her eyes and does what she does best: she grows.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/march_of_the_machine/story/content/epi8-5.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
