...
class MarchPfTheMachineSideStory3 extends StatelessWidget {
  const MarchPfTheMachineSideStory3({Key? key}) : super(key: key);
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  const Center(
                    child: Text(
                      'MARCH OF THE MACHINE | IXALAN: THREE HUNDRED STEPS UNDER THE SUN',
                      style: TextStyle(
                        fontSize: 22,
