...
class MarchPfTheMachineSideStory1 extends StatelessWidget {
  const MarchPfTheMachineSideStory1({Key? key}) : super(key: key);
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  const Center(
                    child: Text(
                      'MARCH OF THE MACHINE | ARCAVIOS: A RADIANT HEART',
                      style: TextStyle(
                        fontSize: 22,
