...
class MarchPfTheMachineSideStory7 extends StatelessWidget {
  const MarchPfTheMachineSideStory7({Key? key}) : super(key: key);
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  const Center(
                    child: Text(
                      'MARCH OF THE MACHINE | NEW CAPENNA: THE FALL OF PARK HEIGHTS',
                      style: TextStyle(
                        fontSize: 22,
...
Around a corner, across three balconies, and down a fire escape they slowed their pace in a lower alley—sides burning and chests heaving. Parnesse leaned against the wall, grabbing both her knees. Errant scanned for any other signs of tagger's scrawl, but there were none. Whoever had highlighted the route they'd followed had ended their graffiti here.
