...
class MarchPfTheMachineSideStory5 extends StatelessWidget {
  const MarchPfTheMachineSideStory5({Key? key}) : super(key: key);
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  const Center(
                    child: Text(
                      'MARCH OF THE MACHINE | ELDRAINE: THE ADVENTURES OF RANKLE, MASTER OF LOVE',
                      style: TextStyle(
                        fontSize: 22,
