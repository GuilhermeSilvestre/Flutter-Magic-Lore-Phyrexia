...
class MarchPfTheMachineSideStory4 extends StatelessWidget {
  const MarchPfTheMachineSideStory4({Key? key}) : super(key: key);
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  const Center(
                    child: Text(
                      'MARCH OF THE MACHINE | INNISTRAD: FAMILY GAME NIGHT',
                      style: TextStyle(
                        fontSize: 22,
