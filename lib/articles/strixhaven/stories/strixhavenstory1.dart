...
class StrixhavenStory1 extends StatelessWidget {
  const StrixhavenStory1({Key? key}) : super(key: key);
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Image.asset(
                      'assets/images/strixhaven/story/content/epi1-1.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
He'd only taken a few steps when he abruptly realized Kasmina wasn't following them. He and Rowan turned and looked back, curious. "Aren't you coming?"''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/strixhaven/story/content/epi1-2.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
"Hey!" called Will, starting after her. "Wait up!"''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/strixhaven/story/content/epi1-3.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
After a moment, Rowan turned and left. Will grabbed his books and hurried after her. But as Rowan moved farther down the hall, Will's steps slowed. Maybe he would have to find answers on his own.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/strixhaven/story/content/epi1-4.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
