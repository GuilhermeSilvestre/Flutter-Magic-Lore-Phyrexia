...
class StrixhavenStory3 extends StatelessWidget {
  const StrixhavenStory3({Key? key}) : super(key: key);
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Image.asset(
                      'assets/images/strixhaven/story/content/epi3-1.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/strixhaven/story/content/epi3-2.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
They followed her into her office. With a gesture, Professor Onyx ignited a few candles, which burned with purple flame. "What was all of that about?"''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/strixhaven/story/content/epi3-3.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
Lukka slammed his weapon against the wall of light, his face contorted with rage. "Frankly? I don't give a damn what he does after all this is burned to the ground."''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/strixhaven/story/content/epi3-4.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
