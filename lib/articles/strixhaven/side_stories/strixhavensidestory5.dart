...
class StrixhavenSideStory5 extends StatelessWidget {
  const StrixhavenSideStory5({Key? key}) : super(key: key);
  @override
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Image.asset(
                      'assets/images/strixhaven/side_story/content/epi5-1.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
"This is for your own good, son. You will learn that one day."''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/strixhaven/side_story/content/epi5-2.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
"Free."''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/strixhaven/side_story/content/epi5-3.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
Doco morphed again into three hand symbols, and without turning around, Killian mimicked them with his own. Light—bring—light. At once the room rippled with blinding white magic. A swirling ball of gold light surrounded him, repelling the sharpened spears Fannessa launched in his direction. Everything the light touched seemed to shine like the sun. And like the sun, he rose high into the air.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/strixhaven/side_story/content/epi5-4.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
