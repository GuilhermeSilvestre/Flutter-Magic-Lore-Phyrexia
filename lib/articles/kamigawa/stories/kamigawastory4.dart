...
class KamigawaStory4 extends StatelessWidget {
  const KamigawaStory4({Key? key}) : super(key: key);
...
The emperor's jaw tensed. Above her, Kyodai howled in confusion. "Do what you must."''',
                  ...
                  Padding(
                    ...
                    child: Image.asset(
                      'assets/images/kamigawa/story/content/epi4-1.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
The emperor twisted her mouth. "Please—we have little time for formalities. Risona and the Asari Uprisers are on their way to Eiganjo as we speak. We must prepare our forces at once."''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/kamigawa/story/content/epi4-2.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
Tamiyo's face was blank. Controlled. "It is not your fault, Kaito. You could not have known what would happen."''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/kamigawa/story/content/epi4-3.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
Something cracked against the back of Kaito's head, and everything around him faded to black.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/kamigawa/story/content/epi4-4.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/kamigawa/story/content/epi4-5.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
