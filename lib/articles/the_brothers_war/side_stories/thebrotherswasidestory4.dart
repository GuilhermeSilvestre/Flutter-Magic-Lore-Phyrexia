...
class TheBrothersWarSideStory4 extends StatelessWidget {
  const TheBrothersWarSideStory4({Key? key}) : super(key: key);
...
Chandra wrested the wine jug away from Jodah and raised it. "This is a celebration, right? So, we toast! To Venser! To Jaya! To Gideon and . . ." Her mouth hung open with the final name, one that Elspeth didn't even have to guess. Ajani.
...
"March!" The soldiers advanced and fanned out, descending the central steps and stopping at the far end of the main pathway. The clay statues stayed behind in the courtyard to absorb any enemies that got past the front line. Everything was set.''',
                  ...
                  Padding(
                    ...
                    child: Image.asset(
                      'assets/images/the_brothers_war/side_story/content/epi4-1.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
Both went down, Rona in a heap and Elspeth onto her knees. She looked over at Jodah lying motionless. Not too late, she thought, her head swimming. Halo . . . With her free hand, she felt for her belt pouch. If any life remained in Jodah, Halo could save him.
