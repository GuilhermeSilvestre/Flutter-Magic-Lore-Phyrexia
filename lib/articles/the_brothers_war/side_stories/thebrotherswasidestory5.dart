...
class TheBrothersWarSideStory5 extends StatelessWidget {
  const TheBrothersWarSideStory5({Key? key}) : super(key: key);
...
Nissa unsheathed the thin, tapered sword hidden in her staff and raised it into the air. "Forward!" she ordered. The mechanical soldiers, followed by lumbering clay statues, led the way down the rampart and onto the field. "Stand your ground! Defend the tower!"''',
                  ...
                  Padding(
                    ...
                    child: Image.asset(
                      'assets/images/the_brothers_war/side_story/content/epi5-1.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
"For the life of every plane," she whispered, "We will all keep watch."''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/the_brothers_war/side_story/content/epi5-2.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
