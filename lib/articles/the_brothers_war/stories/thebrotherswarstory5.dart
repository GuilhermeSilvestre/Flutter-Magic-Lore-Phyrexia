...
class TheBrothersWarStory5 extends StatelessWidget {
  const TheBrothersWarStory5({Key? key}) : super(key: key);
...
"Go."''',
                  ...
                  Padding(
                    ...
                    child: Image.asset(
                      'assets/images/the_brothers_war/story/content/epi5-1.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
"Good enough." Saheeli nodded. "I'll get to work."''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/the_brothers_war/story/content/epi5-2.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
Long, deep trenches striated the land. If Teferi could fly above it, he would look down on a world rippling with muddy scars. Machine and human corpses were thick as crops in a farmer's field, draped over trench and wire, twisted and broken. Between them marched columns of soldiers laden with packs under rain-slicked coats. These were armies of men more dead than alive, as spectral in soul as Teferi was in body.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/the_brothers_war/story/content/epi5-3.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
The Mishra machine had recovered from the avalanche and was now charging up the hill, its dragon head screaming. Urza looked up and saw his brother's face, half-torn from the metallic skull beneath, and wept for him.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/the_brothers_war/story/content/epi5-4.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
Argoth. The Last Battle. Moments before the end of the world, again.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/the_brothers_war/story/content/epi5-5.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
Everything came after.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/the_brothers_war/story/content/epi5-6.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
The dark rushed in.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/the_brothers_war/story/content/epi5-7.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
Urza stood alongside the box and pressed his hand against the lid.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/the_brothers_war/story/content/epi5-8.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
...
Mightstone and Weakstone, reunited at last, within the surviving brother.''',
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 8),
                    child: Image.asset(
                      'assets/images/the_brothers_war/story/content/epi5-9.jpg',
                      fit: BoxFit.cover,
                    ),
                  ),
                  const Padding(
